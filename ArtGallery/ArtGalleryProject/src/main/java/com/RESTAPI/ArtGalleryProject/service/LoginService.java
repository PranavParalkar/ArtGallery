...
public class LoginService implements LoginRoles {
	...
	public String register(LoginCredentials logincred) {
		...
		System.out.println("Username received from frontend: " + logincred.getUsername());

		user.setName(logincred.getUsername());
		System.out.println("Phone received: " + logincred.getPhoneNumber());
		user.setPhoneNumber(logincred.getPhoneNumber());
