            ...
            >
              <div className="relative ">
                <input
                  ...
                  className="flex-1 md:w-[1000px] w-full px-5 py-3 border border-[#e7d5c0] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6b4c35] transition-all bg-[#fefaf6] text-[#3e2e1e] font-medium text-lg shadow"
                  required
                />
